<?php /* force UTF-8 : éàè */
/**
 * Loop Name: Paginated posts list
 *
 * Utilisé par le plugin SiteOrigin Page Builder pour créer une boucle personnalisée paginée.
...
?>
	<section id="post-type-list" class="container siteorigin-post-loop-container">
		<ul class="post-types-list section-content siteorigin-post-loop loop-paginated-list">
<?php
			if ( have_posts() ) :
				while ( have_posts() ) :
					the_post(); 
...
<?php
						if ( has_post_thumbnail() ) {
                             ...
                             **/
                            the_post_thumbnail(
                                apply_filters( '_basique_paginated_posts_list_thumbnail_size', 'medium' ),
...
<?php
             ...
             *
             * Filtre appliqué au nom du fichier partiel contenant la pagination.
             *
             * @since 0.1.0
             *
             * @param string Chaine vide.
             **/
			get_template_part( 'partials/navigations/list', apply_filters( '_basique_loop_list_navigation', '' ) );
?>
		</footer>
	</section><!-- #page-list -->
